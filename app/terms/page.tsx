...
export default function TermsOfServicePage() {
  return (
    ...
    >
      {/* 01. Introduction */}
      <section id="introduction" className="space-y-4 pt-4 border-t-2 border-black">
      ...
      <section id="about-terms" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="services-provided" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="service-scope" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="client-responsibilities" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="project-communication" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="fees-payments" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="ad-spend" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="third-party-platforms" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
        ...
        <p className="font-serifBody text-sm sm:text-base text-neutral-800 leading-relaxed font-normal">
          We manage campaigns across external platforms (Google, Meta, Instagram, WhatsApp, web hosting providers). Creativee World is not liable for platform-wide server outages, policy modifications, account suspensions, or ad approval delays enforced by third-party tech platforms.
        </p>
      </section>

      {/* 10. Website Development Terms */}
      <section id="web-development-terms" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="performance-expectations" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
        ...
        <p className="font-serifBody text-sm sm:text-base text-neutral-800 leading-relaxed font-normal">
          Creativee World applies industry best practices, data-driven ad strategy, and conversion optimization techniques. However, digital marketing outcomes depend on external factors including regional market competition, seasonal buyer demand, search engine algorithm updates, and client sales follow-up speed. 
        </p>
        <p className="font-serifBody text-sm sm:text-base text-neutral-800 leading-relaxed font-normal">
      ...
      <section id="intellectual-property" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
        ...
        <p className="font-serifBody text-sm sm:text-base text-neutral-800 leading-relaxed font-normal">
          Upon receipt of full invoice payment for completed custom website or creative deliverables, rights to final customized client graphics, website source files, and campaign copy transfer to the client. Creativee World retains rights to proprietary agency methodologies, underlying diagnostic frameworks, and non-confidential portfolio presentation rights.
        </p>
      </section>

      {/* 13. Client Materials & Assets */}
      <section id="client-materials" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
        ...
        <p className="font-serifBody text-sm sm:text-base text-neutral-800 leading-relaxed font-normal">
          Clients represent that all trademarks, product photography, text copy, and brand assets provided to Creativee World for campaign use are owned by the client or properly licensed, free of copyright infringement.
        </p>
      </section>

      {/* 14. Confidentiality */}
      <section id="confidentiality" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="third-party-tools" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="limitation-liability" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="suspension-services" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="service-modifications" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
        ...
        <p className="font-serifBody text-sm sm:text-base text-neutral-800 leading-relaxed font-normal">
          Creativee World continuously refines service offerings and package structures to deliver optimal value. Any modification to ongoing client service scopes will be communicated transparently in advance.
        </p>
      </section>

      {/* 20. Governing Law */}
      <section id="governing-law" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="terms-updates" className="space-y-4 pt-8 border-t-2 border-black">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
      ...
      <section id="contact-info" className="space-y-4 pt-8 border-t-2 border-black pb-8">
        <div className="flex items-center space-x-2 font-mono text-xs text-black font-bold uppercase tracking-wider">
        ...
        <div className="p-6 border-2 border-black bg-white space-y-2 font-mono text-xs text-black uppercase">
          <p className="font-bold text-black text-sm">CREATIVEE WORLD COMMERCIAL TEAM</p>
