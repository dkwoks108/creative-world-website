...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      {/* 01. Effective Date */}
      <section id="effective-date" className="space-y-4 pt-4 border-t border-border-subtle/60">
      ...
      {/* 02. Introduction */}
      <section id="introduction" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="information-collected" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="direct-information" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="automatic-information" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="information-use" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="analytics-cookies" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="lead-forms" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="information-sharing" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="third-party-services" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      {/* 11. Data Retention */}
      <section id="data-retention" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      {/* 12. Data Security */}
      <section id="data-security" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="privacy-choices" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="children-privacy" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      {/* 15. External Links */}
      <section id="external-links" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="policy-updates" className="space-y-4 pt-8 border-t border-border-subtle/60">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
      ...
      <section id="contact-us" className="space-y-4 pt-8 border-t border-border-subtle/60 pb-8">
        <div className="flex items-center space-x-2 font-mono text-xs text-coral font-bold uppercase tracking-wider">
