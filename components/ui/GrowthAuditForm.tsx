...
export function GrowthAuditForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="p-8 sm:p-10 rounded-2xl bg-white border border-border-active shadow-editorial text-center space-y-6">
        <div className="h-16 w-16 rounded-full bg-coral/10 border border-coral flex items-center justify-center mx-auto text-coral">
  ...
  return (
    <form
      ...
      className="p-8 sm:p-10 rounded-2xl bg-white border border-border-subtle space-y-6 shadow-editorial"
    >
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-ivory/60 border border-border-subtle text-plum text-sm focus:outline-none focus:border-plum focus:ring-1 focus:ring-plum transition-colors"
            />
            {errors.fullName && (
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-ivory/60 border border-border-subtle text-plum text-sm focus:outline-none focus:border-plum focus:ring-1 focus:ring-plum transition-colors resize-none"
            />
          </div>
