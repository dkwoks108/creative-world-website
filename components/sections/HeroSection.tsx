...
export function HeroSection() {
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-between pt-28 pb-12 overflow-hidden bg-ivory">
      {/* Background Lighting Accents in Logo Spectrum */}
      <div className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-brand-cyan/10 blur-[140px] rounded-full" />
      <div className="pointer-events-none absolute top-1/3 right-10 w-[400px] h-[400px] bg-brand-magenta/10 blur-[160px] rounded-full" />

      {/* Grid Pattern Overlay */}
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,#11111108_1px,transparent_1px),linear-gradient(to_bottom,#11111108_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_40%,#000_70%,transparent_100%)]" />
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8 text-left">
            ...
            <div className="inline-flex items-center space-x-2 w-fit px-3.5 py-1.5 rounded-full bg-white border border-border-subtle shadow-editorial-sm">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-txt-secondary">
                JAIPUR DIGITAL GROWTH AGENCY
              </span>
            </div>

            {/* Main Headline with Selective Official Brand Gradient */}
              ...
              <Link href="/growth-audit">
                <MagneticButton strength={8}>
                  <Button
                    variant="primary"
                    size="lg"
                    className="w-full sm:w-auto rounded-full bg-plum hover:bg-ink-soft text-white"
            ...
            <div className="flex items-center space-x-3 pt-2 text-xs font-mono text-txt-muted">
              ...
              <span>{siteConfig.statusIndicator}</span>
            </div>
          </div>

          {/* Right Column: Integrated 3D Growth Core (5 cols) */}
      ...
      <div className="relative z-10 pt-8">
        <Container variant="wide">
          <div className="flex items-center justify-between border-t border-border-subtle pt-4 text-xs font-mono text-txt-muted">
            <span>[ SYSTEM LAYER: 01 / HERO ]</span>
