...
export function TrustSection() {
  return (
    <section className="relative py-24 bg-ivory border-b border-border-subtle overflow-hidden">
      {/* Background Radial Glow with Mouse Parallax */}
      <MouseParallax strength={10} invert className="pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-coral/5 blur-[120px] rounded-full z-0" />
      ...
      <Container variant="wide" className="space-y-16 relative z-10">
        ...
        <RevealOnScroll variant="fade-up" className="max-w-3xl space-y-4 text-left">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white border border-border-subtle shadow-editorial-sm">
            ...
            <TechScrambler
              text="BUILT FOR MEASURABLE GROWTH"
        ...
        {/* Metric Grid Display with Multi-Layer Mouse Parallax */}
        ...
        <div className="pt-4 border-t border-border-subtle text-xs font-mono text-txt-muted flex justify-between items-center">
          <TechScrambler text="[ SYSTEM LAYER: 02 / PROOF & TRUST ]" />
