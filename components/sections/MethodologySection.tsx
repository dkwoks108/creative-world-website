...
export function MethodologySection() {
  ...
  return (
    <section id="methodology" className="relative py-28 bg-ivory border-b border-border-subtle overflow-hidden">
      {/* Background Lighting Accent with Mouse Parallax */}
      <MouseParallax strength={12} invert className="pointer-events-none absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-coral/5 blur-[170px] rounded-full" />
      </MouseParallax>
      ...
      <Container variant="wide" className="relative z-10 space-y-16">
        ...
        {/* Desktop Process System with Mouse Parallax */}
          ...
          {processData.map((step) => (
            ...
            >
              <div className="flex items-center justify-between border-b border-border-subtle pb-4">
                <TechScrambler text={`STAGE ${step.number}`} className="font-mono text-xs font-bold text-coral" />
        ...
        <div className="pt-4 border-t border-border-subtle text-xs font-mono text-txt-muted flex justify-between items-center">
          <TechScrambler text="[ SYSTEM LAYER: 06 / METHODOLOGY ]" />
